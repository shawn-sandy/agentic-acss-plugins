...
- [ ] An interactive-element request asks which of hover, focus, active, disabled to emit, and emits exactly those
- [ ] An adaptive-sizing request asks container-versus-viewport before choosing @container or @media
