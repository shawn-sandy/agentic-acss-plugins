...
| Plugin | Commands |
|---|---|
| `acss-kit` | `/color-scale`, `/kit-add`, `/kit-create`, `/kit-list`, `/kit-sync`, `/kit-update`, `/prompt-book`, `/setup`, `/style-tune`, `/theme-brand`, `/theme-create`, `/theme-extract`, `/theme-from-design`, `/theme-update`, `/utility-add`, `/utility-bridge`, `/utility-list`, `/utility-tune` |
